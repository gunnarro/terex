...
INSERT INTO project (id, uuid, created_date, last_modified_date, client_id, project_name, project_description, project_status) VALUES(1055, '', current_timestamp, current_timestamp, 1001, 'CatalystOne HRIS modernisering', 'Fra monlith til microservice arkitektur', 'ACTIVE')

-- update timesheet data
DELETE FROM timesheet WHERE id > 1000
INSERT INTO timesheet (id, uuid, created_date, last_modified_date, project_id, timesheet_ref, client_name, project_code, year, month, from_date, working_days_in_month, working_hours_in_month, to_date, status, description) VALUES(1099, '', current_timestamp, current_timestamp, 1055, 'ref', 'client name', 'project code', 2024, 7, current_timestamp, 150, 20, current_timestamp, 'ACTIVE', 'test timesheet')
