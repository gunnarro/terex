...
INSERT INTO integration (id, uuid, created_date, last_modified_date, system, base_url, schema_url, authentication_type, status, user_name, password, access_token, integration_type, read_timeout_ms, connection_timeout_ms, http_headers_content_type) VALUES (2, '', current_timestamp, current_timestamp, 'Jira Tempo', null, null, null, 'ACTIVE', null, null, null, 'CVS_FILE', null, null, null);
...
INSERT INTO user_account (id, uuid, created_date, last_modified_date, user_name, password, account_type, status, organization_id, person_id, is_default_user) VALUES (1, '', current_timestamp, current_timestamp, 'guro', 'change-me', 'BUSINESS', 'ACTIVE', 1001, null, 1 );
